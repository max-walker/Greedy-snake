    ...
    : QWidget(parent)
{
	...
	opera_interval = std::chrono::high_resolution_clock::now();
}
...
bool Greedy_snake::adjuct_operaTime() const
{
	auto now_time = std::chrono::high_resolution_clock::now();
	auto _now = std::chrono::time_point_cast<std::chrono::milliseconds>(now_time).time_since_epoch().count();
	auto _start= std::chrono::time_point_cast<std::chrono::milliseconds>(opera_interval).time_since_epoch().count();
